...
python3 -m py_compile \
  api.py admin.py cli.py config.py database.py detect.py envfile.py gateway.py host.py localdb.py mailer.py manager.py migrate.py paths.py scheduler.py security.py share.py tailscale.py tunnel.py ui.py
